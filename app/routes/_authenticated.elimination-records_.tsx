...
import type { Route } from "./+types/_authenticated.elimination-records_";
...
export default function EliminationRecordsPage({
  loaderData,
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button asChild>
              <Link to="/elimination-records/new">
                  ...
                  <TableRow key={resident.uid}>
                    ...
                    <TableCell className="text-right">
                      <Button variant="outline" size="sm" asChild>
                        <Link
                          to={`/residents/${resident.uid}/elimination-records`}
                        >
                          詳細
                        </Link>
                      </Button>
