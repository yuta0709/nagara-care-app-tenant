...
import type { Route } from "./+types/_authenticated.daily-records_";
...
export default function DailyRecordsPage({ loaderData }: Route.ComponentProps) {
                  ...
                  <TableRow key={resident.uid}>
                    ...
                    <TableCell className="text-right">
                      <Button variant="outline" size="sm" asChild>
                        <Link to={`/residents/${resident.uid}/daily-records`}>
                          詳細
                        </Link>
                      </Button>
                    </TableCell>
